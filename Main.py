...
# Display the torch is available or not
...
class Application:
    ...
    def __init__(self):
        ...
        # Load the Model of the Detector and fingerprint
        ...
        print("Loading FPS Model Complete")
    ...
    def displayLeftMessages(self):
        ...
        if self.ui.comboBox.currentText() == "English":
            ...
            self.ui.pushButton_2.setText("Update IDV Image")
